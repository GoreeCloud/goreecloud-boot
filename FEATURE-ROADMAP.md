# GoreeCloud Boot — Feature Roadmap

**Status:** Active roadmap control  
**As of:** 2026-09-08  
**Authoritative project record:** Project Specification — Boot  
**Canonical repository:** GoreeCloud/goreecloud-boot
**Drive control:** `GoreeCloud/Feature Roadmap/GoreeCloud Boot/FEATURE-ROADMAP.docx`

## Purpose

This file is the repository-side feature roadmap control for GoreeCloud Boot. It records current planned and recommended feature work without replacing the authoritative project record, implementation evidence, release gates, or GoreeCloud Tasks Management.

## Roadmap

| ID | Feature / obligation | Priority | Current state |
| --- | --- | --- | --- |
| FR-001 | Reconcile and maintain every current planned or recommended GoreeCloud Boot feature from the authoritative project record and verified repository evidence in this roadmap. | High | Ongoing control |
